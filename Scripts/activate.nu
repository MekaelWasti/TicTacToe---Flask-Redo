...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\mekae\Desktop\Projects\ML\TicTacToe - Flask Redo'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\mekae\Desktop\Projects\ML\TicTacToe - Flask Redo\Scripts\deactivate.nu'
